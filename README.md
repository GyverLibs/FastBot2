...
- Поддержка всего API Telegram (в ручном режиме)
- Быстрый и удобный парсинг ответов сервера
- Лёгкий вес
- Несколько режимов опроса (short polling, long polling, async)
- Работает на базе Arduino Client, возможно работа по Ethernet, GSM и так далее
