...
FB_MAKE_API(width)
FB_MAKE_API(reply_to_message_id)
...
FB_MAKE_API(forward_sender_name)
...
FB_MAKE_API(disable_web_page_preview)
...
FB_MAKE_API(forward_from_message_id)
...
FB_MAKE_HASH(forward_from_chat)
...
FB_MAKE_HASH(width)
FB_MAKE_HASH(reply_to_message_id)
...
FB_MAKE_HASH(forward_sender_name)
...
FB_MAKE_HASH(disable_web_page_preview)
...
FB_MAKE_HASH(forward_signature)
...
FB_MAKE_HASH(forward_from_message_id)
